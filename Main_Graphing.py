...
def GraphPromptBuilder(ProblemStatement, dfs, filenames):
    ...
    based on the following problem statement '{ProblemStatement}' provide 3 graphs (using Bokeh) that would extract relevant information from the data files:
    """
    ...
    2. all graphs should be in one page using subplots .
    3. your reply in its entirety will be executed in a python environment, therefore, write all of the code together.
    4. available libraries are pandas, numpy, seaborn, matplotlib, additionally do not forget to import the datasets and remember that there maybe multiple file types.
    5. write '#1 start' and '#1 end' at the start end of the first graph, '#2 start' and '#2 end' at the start end of the second graph, '#3 start' and '#3 end' at the start end of the third graph.
    """
...
ProblemStatement = "what was the age group with the most deaths,and why?"
